...
import { withRouter } from 'react-router-dom'; //To be able to redirect from inside axios call
...
class Register extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.props.registerUser(newUser, this.props.history); //Passing history method to be able to redirect from within the action
  }
